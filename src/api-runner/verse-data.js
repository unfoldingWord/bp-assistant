...
// Code -> spelled-out English book name. Callers that put a reference in front
// of a model need the name, not just the code: a 3-letter code leaves the model
// to guess which book it is working in, and it guesses from whatever book names
// happen to appear elsewhere in the prompt.
const BOOK_NAMES = {
